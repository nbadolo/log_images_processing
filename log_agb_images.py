...
#%%        
    ...
    for l in range(n_lst_fltr3):
        ...
        #                 dpi=100, bbox_inches ='tight')
        plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/All_plots/star_psf_old/'+ 
                    star_name +'_' + fltr + '.pdf', 
                          dpi=100, bbox_inches ='tight')
        plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/All_plots/star_psf_old/'+ 
                    star_name +'_' + fltr + '.png', 
                          dpi=100, bbox_inches ='tight')
        plt.tight_layout()
    ...
    for m in range(n_lst_fltr3):
        ...
        #                 dpi = 100, bbox_inches ='tight')
        plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/All_plots/star_psf_old/'+ 
                    star_name +'_' + fltr_ + '.pdf', 
                          dpi=100, bbox_inches ='tight')
        plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/All_plots/star_psf_old/'+ 
                    star_name +'_' + fltr_  + '.png', 
                          dpi=100, bbox_inches ='tight')
        plt.tight_layout()
