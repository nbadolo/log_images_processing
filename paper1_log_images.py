               ...
               for l in range(n_lst_fltr2) :
                   ...
                   for z in range(n_fsize) :
                        ...
                        plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/First/'+star_name+
                                          '/plots/no_psf/I/'+ star_name +'_' +  f'{fltr_arr[z]}' + '_lin' + '.pdf', 
                                          dpi=100, bbox_inches ='tight')
                        
                        plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/First/'+star_name+
                                          '/plots/no_psf/I/'+ star_name +'_' +  f'{fltr_arr[z]}'  + '_lin' + '.png', 
                                          dpi=100, bbox_inches ='tight')         
                        
                        # plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/All_plots/star_psf/paper1/pdf/'+star_name+
                        #      '_' +  f'{fltr_arr[z]}' + '_lin' + '.pdf', dpi=100, bbox_inches ='tight')
                        
                        # plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/All_plots/star_psf/paper1/png/'+star_name+
