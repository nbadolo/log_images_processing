...
#%%       
    ...
    #       plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/large_log/'+star_name+
    #                          '/plots/no_psf/'+star_name+'_' + fltr_ +'_lin' + '.pdf', 
    #                          dpi=100, bbox_inches ='tight')
           
           
    #       plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/large_log/'+star_name+
    #                          '/plots/no_psf/'+star_name+'_' + fltr_ +'_lin' + '.png', 
    #                          dpi=100, bbox_inches ='tight')
    ...
    #       plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/large_log/'+star_name+
    #                         '/plots/no_psf/'+ star_name +'_' + fltr_ + '_log' + '.pdf', 
    #                         dpi=100, bbox_inches ='tight')
         
    #       plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/large_log/'+star_name+
    #                         '/plots/no_psf/'+ star_name +'_' + fltr_ + '_log' + '.png', 
    #                         dpi=100, bbox_inches ='tight')
